...
const Sidebar = () => {
  return (
    <div className="Sidebar w-1/4 max-w-sm bg-linear-to-br from-yellow-200 via-pink-200 to-pink-200 p-8 flex flex-col items-center text-center shadow-lg fixed top-0 left-0 h-screen overflow-auto">
